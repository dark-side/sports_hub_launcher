...
- Color-coded options for easy navigation
...
You can change these settings anytime using the **SETTINGS** section in the main menu ([T], [F], [M]).
...
### Example 2: Switch Technology Stack
```bash
# From main menu:
...
### Example 3: View API Information
```bash
# From main menu:
# Press [A] to see all API endpoints, URLs, and example curl commands
```

### Example 4: Export Logs for Debugging
```bash
# From main menu:
